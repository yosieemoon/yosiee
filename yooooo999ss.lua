...
_G.FishItConfig = _G.FishItConfig or {
    ["Fishing"] = {
        ...
        ["Auto Favorite"] = true,
        ["Fish Name"] = {
            "Ruby","Sacred Guardian Squid","Sacred Guardian Squid","Holiday Turtle Plushie","Gingerbread Ray","Tree Horse","Reindeer Shark","Giftback Turtle","Christmas Penguin", 
        },
    ...
    ["Rod List"] = {
        ...
        ["Location Rods"] = { -- Farm location and minimum rod to start on that location, also only 1 rod and only 1 location
            ...
            ["Esoteric Depths"] = {"Ghostfinn Rod", "Angler Rod", "Ares Rod", "Bamboo Rod"},
